...
export default function SimpleSlider() {
  ...
  function NextArrow(props: ArrowProps) {
    const { onClick } = props;
    return (
      <div onClick={onClick} className="absolute right-[40px] top-[-25%] z-10 bg-[#F5F5F5] text-black w-[50px] h-[50px] text-xl
  ...
  function PrevArrow(props: ArrowProps) {
    const { onClick } = props;
    return (
      <div onClick={onClick} className="absolute right-[100px] top-[-25%] z-10 bg-[#F5F5F5] text-black w-[50px] h-[50px] text-xl
       flex items-center justify-center rounded-full cursor-pointer hover:bg-black hover:text-white transition">
        <FaArrowLeft />
      </div>
    );
  ...
  return (
    <Slider {...settings}>
        ...
        <h3 className="text-xl font-semibold text-black mb-2">HAVIT HV-G92 Gamepad</h3>
        <h4 className="text-xl font-semibold text-[var(--main-color)] mb-2">$120 <span className="ml-3 line-through text-gray-500">$160</span></h4>
        <div className="flex items-center gap-3 ">
            <ul className="flex items-center gap-1">
            <li className="text-xl font-medium text-[#FFAD33]"><GoStarFill /></li>
            <li className="text-xl font-medium text-[#FFAD33]"><GoStarFill /></li>
        ...
        <h3 className="text-xl font-semibold text-black mb-2">AK-900 Wired Keyboard</h3>
        <h4 className="text-xl font-semibold text-[var(--main-color)] mb-2">$960 <span className="ml-3 line-through text-gray-500">$1160</span></h4>
        <div className="flex items-center gap-3 ">
            <ul className="flex items-center gap-1">
            <li className="text-xl font-medium text-[#FFAD33]"><GoStarFill /></li>
            <li className="text-xl font-medium text-[#FFAD33]"><GoStarFill /></li>
        ...
        <h3 className="text-xl font-semibold text-black mb-2">IPS LCD Gaming Monitor</h3>
        <h4 className="text-xl font-semibold text-[var(--main-color)] mb-2">$370 <span className="ml-3 line-through text-gray-500">$400</span></h4>
        <div className="flex items-center gap-3 ">
            <ul className="flex items-center gap-1">
            <li className="text-xl font-medium text-[#FFAD33]"><GoStarFill /></li>
            <li className="text-xl font-medium text-[#FFAD33]"><GoStarFill /></li>
